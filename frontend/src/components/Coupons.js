    ...
    constructor() {
        ...
        this.state = {
            people: [{
                ...
                heading: "Prime Deals",
                offer: "Tim Hortons  ",
                detailsInfo: "Tim Hortons: BOGO FREE Iced Lattes Coupon"
            ...
            },
            {
                ...
                detailsInfo: "Brahmastra movie voucher at discounted rate and free ticket contest "
            },
            {
                id:3,
                image: require("../assets/logos/coupon2.png"),
                heading: "20% OFF on drinks",
                offer: " Starbucks Card}",
                detailsInfo: "Starbucks Coupons: Possibly FREE Cold Drink {with a Starbucks Card}"
